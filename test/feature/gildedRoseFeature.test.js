...
describe("So that I can keep track of my stock", function() {
  it("I want to maint an inventory of items", function() {
...
describe("Manages the quality of an inventory over time", function() {
  ...
  const inventory = new Shop(inventoryItems)
  ...
  it("Normal items quality decrease by 1 before sellIn date + 'Aged Brie' actually increases in Quality the older it gets", function() {
    ...
    expect(inventory.items[0].quality).toBe(2)
    expect(inventory.items[1].quality).toBe(3)
    expect(inventory.items[2].quality).toBe(6)
    expect(inventory.items[3].quality).toBe(80)
    expect(inventory.items[4].quality).toBe(6)
  })
  ...
  it("Once the sell by date has passed, Quality degrades twice as fast + BACKSTAGE PASS Quality increases by 2 with less than 10 sellIn days", function() {
    inventory.updateQuality()
    expect(inventory.items[0].quality).toBe(0)
    expect(inventory.items[4].quality).toBe(8)
  })
  ...
  it("BACKSTAGE PASS Quality increases by 3 with less than 5 sellIn days + The Quality of an item is never negative", function() {
    ...
    expect(inventory.items[0].quality).toBe(0)
    expect(inventory.items[4].quality).toBe(19)
  })
  ...
  it("BACKSTAGE PASS Quality drops to 0 after the concert", function() {
    ...
    expect(inventory.items[4].quality).toBe(0)
  })
  ...
  it("The Quality of an item is never more than 50", function() {
    ...
    expect(inventory.items[2].quality).not.toBeGreaterThan(50)
  })
